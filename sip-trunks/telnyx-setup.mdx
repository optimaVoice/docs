...
- Access to the [Telnyx Portal](https://portal.telnyx.com)
...
3. Click **"Add Number"** → **"Manual Configuration"** tab
4. Fill in:
   - **Trunk Name:** "Telnyx - Main Line" (or any label you prefer)
   - **Phone Number:** Your Telnyx number (format: +1234567890)
   - **Assigned Agent:** Select which agent handles calls
5. Click **"Create Phone Number"**

**The destination you'll enter in Telnyx:**
...
<Note>
You'll paste this address into the Telnyx portal in the steps below.
</Note>
...
2. Set **"Send SIP INVITE to"**:
   - **Destination:** `sip:sip.optima-voice.com:5060`
   - **Protocol:** UDP
   - **Port:** 5060
